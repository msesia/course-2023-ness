...
class QuantileNNet(nn.Module):
    ...
    def __init__(self, quantiles, num_features, num_hidden=64, dropout=0.1, no_crossing=False):
        ...
        """
        super(QuantileNNet, self).__init__()
...
class QNet:
    ...
    def __init__(self, quantiles, num_features, no_crossing=False, dropout=0.2, learning_rate=0.001,
        ...
        # Define NNet model
        self.model = QuantileNNet(self.quantiles, self.num_features, num_hidden=num_hidden, dropout=dropout, no_crossing=no_crossing)
